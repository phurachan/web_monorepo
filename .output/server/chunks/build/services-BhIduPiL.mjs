...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li><a href="#" class="hover:text-white transition-colors">${ssrInterpolate(unref(t)("footer.ourPeople"))}</a></li><li><a href="#" class="hover:text-white transition-colors">${ssrInterpolate(unref(t)("footer.careers"))}</a></li><li><a href="#" class="hover:text-white transition-colors">${ssrInterpolate(unref(t)("footer.blog"))}</a></li></ul></div><div><h4 class="text-lg font-bold mb-4">${ssrInterpolate(unref(t)("footer.contact"))}</h4><ul class="space-y-2 text-gray-400"><li>+1 (555) 123-4567</li><li>hello@digitalflow.com</li><li>123 Innovation Drive<br>Tech Valley, CA 94105</li></ul></div></div><div class="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400"><p>\xA9 2025 ${ssrInterpolate(unref(siteSettings).siteName)}. All rights reserved.</p></div></div></footer></div>`);
    };
  }
};
...
//# sourceMappingURL=services-BhIduPiL.mjs.map
