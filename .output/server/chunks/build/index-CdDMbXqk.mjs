  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(services), (service) => {
        ...
        if ((_a = service.features) == null ? void 0 : _a.length) {
      ...
      _push(`</li></ul></div></div><div class="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400" data-v-9f86c6e9><p data-v-9f86c6e9>\xA9 2025 ${ssrInterpolate(unref(siteSettings).siteName)}. All rights reserved.</p></div></div></footer></div>`);
    };
  }
};
...
//# sourceMappingURL=index-CdDMbXqk.mjs.map
