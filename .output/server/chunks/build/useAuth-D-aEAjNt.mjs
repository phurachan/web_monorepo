import { u as useState, b as buildApiUrl, A as API_ENDPOINTS } from './api-ChRidk0C.mjs';
...
const useAuth = () => {
  ...
  const login = async (email, password) => {
    ...
    try {
      ...
      return {
        success: false,
        error: ((_a = error.data) == null ? void 0 : _a.message) || error.message || "Login failed"
      };
    }
  };
  const logout = async () => {
  ...
  const setupAdmin = async (email, password, name) => {
    ...
    try {
      ...
      return {
        success: false,
        error: ((_a = error.data) == null ? void 0 : _a.message) || error.message || "Setup failed"
      };
    }
  };
  return {
...
export { useAuth as u };
//# sourceMappingURL=useAuth-D-aEAjNt.mjs.map
