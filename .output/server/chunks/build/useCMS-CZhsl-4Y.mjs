...
const useCMS = () => {
  ...
  const getServices = async () => {
    try {
      ...
      const servicesWithParsedFeatures = (data == null ? void 0 : data.map((service) => ({
        ...service,
  ...
  const getFAQs = async () => {
    try {
      ...
      return (data == null ? void 0 : data.filter((f) => f.isActive)) || [];
    } catch (error) {
...
export { useCMS as u };
//# sourceMappingURL=useCMS-CZhsl-4Y.mjs.map
