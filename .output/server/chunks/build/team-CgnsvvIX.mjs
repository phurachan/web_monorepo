import { _ as __nuxt_component_0, a as _imports_0, b as _imports_1, c as _imports_2, d as _imports_3, e as _imports_4, f as _imports_5 } from './virtual_public-WLkNAOig.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-CKoRUFr1.mjs';
...
import { b as buildApiUrl, A as API_ENDPOINTS } from './api-ChRidk0C.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li data-v-b13a8c0d><a href="#" class="hover:text-white transition-colors" data-v-b13a8c0d>${ssrInterpolate(unref(t)("footer.careers"))}</a></li><li data-v-b13a8c0d><a href="#" class="hover:text-white transition-colors" data-v-b13a8c0d>${ssrInterpolate(unref(t)("footer.blog"))}</a></li></ul></div><div data-v-b13a8c0d><h4 class="text-lg font-bold mb-4" data-v-b13a8c0d>${ssrInterpolate(unref(t)("footer.contact"))}</h4><ul class="space-y-2 text-gray-400" data-v-b13a8c0d><li data-v-b13a8c0d>+1 (555) 123-4567</li><li data-v-b13a8c0d>hello@digitalflow.com</li><li data-v-b13a8c0d>123 Innovation Drive<br data-v-b13a8c0d>Tech Valley, CA 94105</li></ul></div></div><div class="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400" data-v-b13a8c0d><p data-v-b13a8c0d>\xA9 2025 ${ssrInterpolate(unref(siteSettings).siteName)}. All rights reserved.</p></div></div></footer></div>`);
    };
  }
};
...
//# sourceMappingURL=team-CgnsvvIX.mjs.map
